    ...
    return(
        <AuthenticatedLayout
            ...
            header={
                <div className="flex justify-between items-center">
                    ...
                    <Link href={route('project.edit', project.id)} className="bg-blue-500 py-1 px-3 text-white rounded shadow transition-all hover:bg-blue-600">
                        Edit
                    </Link>
                </div>
            }
        ...
        <div className="px-12">
            <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div className="p-6 text-gray-900 dark:text-gray-100">
                        <TasksTable success={success} tasks={tasks} queryParams={queryParams} hideProjectColumn={true}/>
                    </div>
                </div>
            </div>
        </div>
